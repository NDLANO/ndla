...
case class AlternativeDTO(
    @description("Unique identifier for the alternative") id: String,
    @description("Answer text") text: String,
    @description("Whether this alternative is correct (visible to staff only)") isCorrect: Option[Boolean],
)
...
case class GlossaryPairDTO(
    @description("Word or term") word: String,
    @description("Definition or translation") definition: String,
)
...
case class QuestionDTO(
    @description("Unique identifier") id: String,
    @description("Question type") questionType: QuestionType,
    @description("Question text") title: String,
    @description("Answer alternatives (SINGLE_CHOICE / MULTI_CHOICE)") alternatives: Seq[AlternativeDTO],
    @description("Glossary pairs (MATCHING)") glossaryPairs: Seq[GlossaryPairDTO],
    @description("Creation date") created: NDLADate,
    @description("Last updated date") updated: NDLADate,
)
object QuestionDTO {
...
case class NewQuestionDTO(
    @description("Question type") questionType: QuestionType,
    @description("Question text") title: String,
    @description("Answer alternatives") alternatives: Seq[NewAlternativeDTO],
    @description("Glossary pairs for MATCHING questions") glossaryPairs: Seq[GlossaryPairDTO],
)
...
case class UpdateQuestionDTO(
    @description("Question type") questionType: Option[QuestionType],
    @description("Question text") title: Option[String],
    @description("Answer alternatives (replaces all if provided)") alternatives: Option[Seq[NewAlternativeDTO]],
    @description("Glossary pairs (replaces all if provided)") glossaryPairs: Option[Seq[GlossaryPairDTO]],
)
...
case class NewAlternativeDTO(
    @description("Answer text") text: String,
    @description("Whether this alternative is correct") isCorrect: Boolean,
)
...
@description("A quiz")
case class QuizDTO(
    @description("Unique identifier") id: Long,
    @description("Revision number") revision: Int,
    @description("Quiz title") title: String,
    @description("Quiz description") description: Option[String],
    @description("Questions in this quiz") questions: Seq[QuestionDTO],
    @description("Status") status: QuizStatus,
    @description("Creation date") created: NDLADate,
    @description("Last updated date") updated: NDLADate,
    @description("Published date") published: Option[NDLADate],
    @description("Display settings") displaySettings: DisplaySettings,
)
object QuizDTO {
...
case class NewQuizDTO(
    @description("Quiz title") title: String,
    @description("Quiz description") description: Option[String],
    @description("Display settings") displaySettings: Option[DisplaySettings],
)
object NewQuizDTO {
...
case class UpdateQuizDTO(
    @description("Revision number for optimistic locking") revision: Int,
    @description("Quiz title") title: Option[String],
    @description("Quiz description") description: Option[String],
    @description("Display settings") displaySettings: Option[DisplaySettings],
)
...
case class UpdateStatusDTO(
    @description("New status") status: QuizStatus,
)
...
case class QuestionAnswerDTO(
    @description("Question ID") questionId: String,
    @description("Selected alternative IDs (SINGLE_CHOICE / MULTI_CHOICE)") selectedAlternativeIds: Seq[String],
    @description("Matched pairs (MATCHING): word -> definition") matchedPairs: Seq[GlossaryPairDTO],
)
...
case class QuestionResultDTO(
    @description("Question ID") questionId: String,
    @description("Whether the answer is fully correct") isCorrect: Boolean,
    @description("Score for this question") score: Int,
    @description("Maximum possible score") maxScore: Int,
    @description("IDs of the correct alternatives (revealed after check)") correctAlternativeIds: Seq[String],
    @description("Correct pairs (revealed after check for MATCHING)") correctPairs: Seq[GlossaryPairDTO],
)
...
case class CheckQuizDTO(
    @description("Answers for each question") answers: Seq[QuestionAnswerDTO],
)
object CheckQuizDTO {
...
case class QuizResultDTO(
    @description("Total score achieved") totalScore: Int,
    @description("Maximum possible score") maxScore: Int,
    @description("Per-question results") results: Seq[QuestionResultDTO],
)
