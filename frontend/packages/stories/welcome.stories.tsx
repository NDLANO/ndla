    ...
    <ArticleWrapper>
      <ArticleContent>
        <section>
          ...
          <p>
            <i>
              NB: Grunnet overgang til ny profil er komponenter i ferd med å bli
              byttet ut med nyere versjoner, og vil derfor ikke se helt korrekte
              ut her.
            </i>
          </p>
          ...
          <p>
            ...
            innholdselementer utvikles videre med reell funksjonalitet, kan de
            tas inn i designmanualen og erstatte de gamle elementene.
          </p>
          <p>
            Den er ikke en brukermanual for innholdsproduksjon. Råd og
            retningslinjer for produksjon av innhold ligger i{" "}
            <a
              href="https://kvalitet.ndla.no"
              target="_blank"
          ...
          <p>
            ...
            hovedsakelig tre deler:
          </p>
          <UnOrderedList>
            <li>
              <b>preset-panda</b>: En{" "}
              <a href="https://panda-css.com">Panda-css</a>-preset som genererer
              CSS som alle NDLA-applikasjoner bruker.
            </li>
            <li>
              <b>primitives</b>: Et komponentbibliotek bestående av
              grunnkomponenter, bygget på toppen av Panda-CSS og{" "}
              <a href="https://ark-ui.com">ark-ui</a>.
            </li>
            <li>
              <b>ui</b>: NDLA-spesifikke komponenter som bygger på toppen av
              våre eksisterende primitives.
            </li>
          </UnOrderedList>
          <p>
            Hovedapplikasjonene til NDLA er skrevet i{" "}
            <a href="https://react.dev">React</a>, og publiseres på{" "}
          ...
          <UnOrderedList>
            ...
            <li>
              <b>Source Serif 4</b>: Serif-fonten til NDLA. Hentes fra{" "}
              <a href="https://fontsource.org/">Fontsource</a>.
            </li>
            <li>
              <b>Source Code Pro Variable</b>: Brukes til fremvisning av
              kodesnutter. Hentes fra{" "}
              <a href="https://fontsource.org/">Fontsource</a>.
            </li>
          </UnOrderedList>
          <p>
            Fontsource-fontene kan installeres ved hjelp av NPM. De heter
            henholdsvis
            <code>@fontsource-variable/source-serif-4</code> og{" "}
            <code>@fontsource-variable/source-code-pro</code>. Satoshi må hentes
            fra Fontshare sin CDN.
          </p>
          <p>
            Dersom du kun skal bruke primitives-komponentene vil du kun ha behov
            for Satoshi, gitt at du ikke bruker tekststiler som er tiltenkt for
            bruk i NDLA sine artikler.
          </p>
          ...
          <p>
            ...
            <a href="https://github.com/NDLANO/ndla-frontend/blob/master/panda.config.ts">
              ndla-frontend
            </a>
          </p>
          <p>
            Alternativt eksporterer vi CSS-filer fra alle pakker. Dersom du skal
            bruke en av pakkene våre er det nødvendig å ha med css fra{" "}
            <code>@ndla/preset-panda</code>:
          </p>
          <code>@import '@ndla/preset-panda/dist/styles.css';</code>
          <p>
            Du vil deretter være nødt til å importere css for hver pakke du tar
            i bruk.
          </p>
