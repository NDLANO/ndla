...
const heroRecipe = sva({
  ...
  base: {
    ...
    content: {
      ...
      alignItems: "flex-end",
      paddingBlock: "xsmall",
      tablet: { paddingBlockStart: "xxlarge" },
    },
  },
  defaultVariants: { variant: "primary", absolute: true },
  variants: {
    absolute: { true: { background: { position: "absolute" } } },
    variant: {
      primary: { background: { background: "primary" }, content: { "@media not print": { color: "text.onAction" } } },
      brand2Bold: {
        background: { background: "surface.brand.2.bold" },
        content: { "@media not print": { color: "text.onAction" } },
      },
      ...
      brand5Moderate: { background: { background: "surface.brand.5.moderate" } },
      neutral: { background: { background: "surface.infoSubtle" } },
    },
  },
});
