...
export default {
  ...
  component: Image,
  tags: ["autodocs"],
  args: { alt: "Mann med maske", src: "https://api.test.ndla.no/image-api/raw/id/604" },
  parameters: { inlineStories: true },
} as Meta<typeof Image>;

const crop: ImageCrop = { startX: 14.59, endX: 79.63, startY: 20, endY: 100 };

const focalPoint: ImageFocalPoint = { x: 65.08, y: 45.28 };

export const Default: StoryObj<typeof Image> = {};

export const Rounded: StoryObj<typeof Image> = { args: { variant: "rounded" } };

export const Crop: StoryObj<typeof Image> = { args: { crop } };

export const FocalPoint: StoryObj<typeof Image> = { args: { focalPoint, sizes: "(min-width: 320px) 320px" } };

export const LazyLoad: StoryObj<typeof Image> = {
  args: { alt: "Lyspære", src: "https://api.staging.ndla.no/image-api/raw/Ide.jpg", loading: "lazy" },
};
...
export const Svg: StoryObj<typeof Image> = {
  args: { alt: "Osmose", src: "https://api.ndla.no/image-api/raw/ESJ2EgIi.svg" },
};
