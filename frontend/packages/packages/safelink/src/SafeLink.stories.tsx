...
export const Disabled: StoryObj<typeof SafeLink> = { args: { disabled: true } };

export const ExternalLink: StoryObj<typeof SafeLink> = { args: { to: "https://example.com", target: "_blank" } };
