...
const translations = {
  ...
  license: {
    ...
    image: { rules: "Regler for bruk av bildet:" },
    images: {
    ...
    video: {
      ...
      itemImage: { ariaLabel: "Åpne film i et nytt vindu" },
    ...
    other: {
      ...
      itemImage: { ariaLabel: "Åpne i nytt vindu" },
    },
    h5p: {
  ...
  figure: { button: { alternative: "Bytt til synstolket film", original: "Bytt til original film" } },
  contentTypes: {
    all: "Alle",
    article: "Artikkel",
    subject: "Fag",
  ...
  breadcrumb: { toFrontpage: "NDLA forside", breadcrumb: "Brødsmulesti" },
  ...
  wordClass: {
    ...
    noun: "Substantiv",
    "noun-zh": "Nomen",
    "noun-phrase": "Nominalfrase",
    onomatopoeia: "Onomatopoetikon",
    particle: "Partikkel",
    demonstrative: "Pekeord",
    "personal-pronoun": "Personlig pronomen",
    prefix: "Prefiks",
    preposition: "Preposisjon",
    pronoun: "Pronomen",
    "question-word": "Spørreord",
    "location-word": "Stedsord",
    suffix: "Suffiks",
    numeral: "Tallord",
    "time-word": "Tidsord",
    "time-expression": "Tidsuttrykk",
    "stative-verb": "Tilstandsverb",
    "subordinating-conjunction": "Subjunksjon",
    "exclamation-word": "Utropsord",
    expression: "Uttrykk",
    verb: "Verb",
    "verb-complement": "Verb-komplement",
    "verb-object": "Verb-objekt",
  },
  login: "Logg inn",
  component: {
    tagsInput: {
  ...
  articleTraits: { AUDIO: "Lyd", INTERACTIVE: "Interaktivt innhold", PODCAST: "Podkast", VIDEO: "Film" },
