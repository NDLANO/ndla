...
const messages = {
  ...
  subjectCategories: {
    active: "Doaimmas",
    archive: "Ii doaimmas šat",
    beta: "Boahttevaš",
    otherResources: "Eará resurssat",
    resourceCollection: "Resursačoakkáldat",
  },
  subjectTypes: {
    archiveSubject: "Arkivfag",
    betaSubject: "Betafága",
    resourceCollection: "Resursačoakkáldat",
    subject: "Fága",
  },
  meta: {
  ...
  wordClass: {
    ...
    adverb: "Advearba",
    properNoun: "Iežas namma",
    "proper-noun": "Iežas namma",
    auxiliary: "Veahkkesánit",
    complement: "Dievasmahttin",
    conjunction: "Konjunksjon",
    coverb: "Koverb",
    determiner: "Mearrádussánit",
    interjection: "Ovttastuvvon",
    quantifier: "Kvantor",
    marker: "Sieván",
    modalVerb: "Modálavearba",
    "modal-verb": "Modálavearba",
    measureWord: "Olahussátni",
    "measure-word": "Olahussátni",
    noun: "Substantiivvat",
    "noun-zh": "Nome",
    nounPhrase: "Nomengihppu",
    "noun-phrase": "Nomengihppu",
    onomatopoeia: "Onomatopoetikon",
    particle: "Partihkkalat",
    demonstrative: "Čujuhusat",
    personalPronoun: "Persovnnalaš pronomen",
    "personal-pronoun": "Persovnnalaš pronomen",
    prefix: "Prefiksa",
    preposition: "Preposišuvdna",
    pronoun: "Pronomen",
    questionWord: "Jearaldatsánit",
    "question-word": "Jearaldatsánit",
    locationWord: "Báikesánit",
    "location-word": "Báikesánit",
    suffix: "Suffivssat",
    numeral: "Lohkosánit",
    timeWord: "Áigebágo",
    "time-word": "Áigebágo",
    timeExpression: "Áigemearka",
    "time-expression": "Áigemearka",
    stativeVerb: "Dili-vearbba",
    "stative-verb": "Dili-vearbba",
    subordinatingConjunction: "Subjunkšuvdna",
    "subordinating-conjunction": "Subjunkšuvdna",
    exclamationWord: "Ii-rohkossátni",
    "exclamation-word": "Ii-rohkossátni",
    expression: "Ovdanbuktin",
    verb: "Vearbbat",
    verbComplement: "Vearbasuorggideapmi",
    "verb-complement": "Vearbasuorggideapmi",
    verbObject: "Vearbaobjeakta",
    "verb-object": "Vearbaobjeakta",
  },
  login: "Čálit sisa",
  component: {
    tagsInput: {
