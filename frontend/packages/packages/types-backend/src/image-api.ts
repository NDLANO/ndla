...
export type components = {
  schemas: {
     ...
     */
    ImageVariantSize:
      "icon" | "xsmall" | "small" | "medium" | "large" | "xlarge" | "xxlarge";
    /**
     * LicenseDTO
...
export type CopyMetaDataAndFileForm =
  components["schemas"]["CopyMetaDataAndFileForm"];
...
export type ImageMetaInformationV2DTO =
  components["schemas"]["ImageMetaInformationV2DTO"];
export type ImageMetaInformationV3DTO =
  components["schemas"]["ImageMetaInformationV3DTO"];
...
export type NewImageMetaInformationV2DTO =
  components["schemas"]["NewImageMetaInformationV2DTO"];
...
export type UpdateImageMetaInformationDTO =
  components["schemas"]["UpdateImageMetaInformationDTO"];
export type UpdateMetaDataAndFileForm =
  components["schemas"]["UpdateMetaDataAndFileForm"];
