...
export type components = {
  schemas: {
    ...
    ArticleDTO: {
      ...
      relatedContent: (
        components["schemas"]["RelatedContentLinkDTO"] | number
      )[];
...
export type GrepCodesSearchResultDTO =
  components["schemas"]["GrepCodesSearchResultDTO"];
