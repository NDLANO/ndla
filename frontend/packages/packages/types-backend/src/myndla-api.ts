...
export type ConfigMetaRestrictedDTO =
  components["schemas"]["ConfigMetaRestrictedDTO"];
...
export type CreateRobotDefinitionDTO =
  components["schemas"]["CreateRobotDefinitionDTO"];
...
export type FolderSortRequestDTO =
  components["schemas"]["FolderSortRequestDTO"];
...
export type ListOfRobotDefinitionsDTO =
  components["schemas"]["ListOfRobotDefinitionsDTO"];
...
export type ResourceConnectionDTO =
  components["schemas"]["ResourceConnectionDTO"];
...
export type RobotConfigurationDTO =
  components["schemas"]["RobotConfigurationDTO"];
...
export type SingleResourceStatsDTO =
  components["schemas"]["SingleResourceStatsDTO"];
...
export type UpdatedMyNDLAUserDTO =
  components["schemas"]["UpdatedMyNDLAUserDTO"];
