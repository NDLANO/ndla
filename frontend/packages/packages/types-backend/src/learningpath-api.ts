...
export type NewCopyLearningPathV2DTO =
  components["schemas"]["NewCopyLearningPathV2DTO"];
export type NewLearningPathV2DTO =
  components["schemas"]["NewLearningPathV2DTO"];
export type NewLearningStepV2DTO =
  components["schemas"]["NewLearningStepV2DTO"];
