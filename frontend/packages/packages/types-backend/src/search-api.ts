...
export type components = {
  schemas: {
    ...
    AllErrors:
      ...
      | components["schemas"]["NotFoundWithSupportedLanguages"]
    ...
    /** GrepResultDTO */
    GrepResultDTO:
      | components["schemas"]["GrepFagkodeDTO"]
      | components["schemas"]["GrepKjerneelementDTO"]
      | components["schemas"]["GrepKompetansemaalDTO"]
      | components["schemas"]["GrepKompetansemaalSettDTO"]
      | components["schemas"]["GrepLaererplanDTO"]
      | components["schemas"]["GrepTverrfagligTemaDTO"];
    /**
     * GrepSearchInputDTO
     ...
     */
    GrepStatusDTO:
      "Published" | "InProgress" | "ToRevision" | "Expired" | "Invalid";
    /**
    ...
    /** MultiSummaryBaseDTO */
    MultiSummaryBaseDTO:
      | components["schemas"]["MultiSearchSummaryDTO"]
      | components["schemas"]["NodeHitDTO"];
    /** NodeHitDTO */
    NodeHitDTO: {
     ...
     */
    SearchType:
      "article" | "draft" | "learningpath" | "concept" | "grep" | "node";
    /**
     * Sort
...
export type ApiTaxonomyContextDTO =
  components["schemas"]["ApiTaxonomyContextDTO"];
...
export type DraftSearchParamsDTO =
  components["schemas"]["DraftSearchParamsDTO"];
...
export type GrepKjerneelementDTO =
  components["schemas"]["GrepKjerneelementDTO"];
export type GrepKjerneelementDTO1 =
  components["schemas"]["GrepKjerneelementDTO1"];
export type GrepKompetansemaalDTO =
  components["schemas"]["GrepKompetansemaalDTO"];
export type GrepKompetansemaalDTO1 =
  components["schemas"]["GrepKompetansemaalDTO1"];
export type GrepKompetansemaalSettDTO =
  components["schemas"]["GrepKompetansemaalSettDTO"];
export type GrepKompetansemaalSettDTO1 =
  components["schemas"]["GrepKompetansemaalSettDTO1"];
...
export type GrepReferencedKjerneelementDTO =
  components["schemas"]["GrepReferencedKjerneelementDTO"];
export type GrepReferencedKompetansemaalDTO =
  components["schemas"]["GrepReferencedKompetansemaalDTO"];
export type GrepReferencedKompetansemaalSettDTO =
  components["schemas"]["GrepReferencedKompetansemaalSettDTO"];
export type GrepReferencedLaereplanDTO =
  components["schemas"]["GrepReferencedLaereplanDTO"];
...
export type GrepSearchResultsDTO =
  components["schemas"]["GrepSearchResultsDTO"];
...
export type GrepTverrfagligTemaDTO =
  components["schemas"]["GrepTverrfagligTemaDTO"];
export type GrepTverrfagligTemaDTO1 =
  components["schemas"]["GrepTverrfagligTemaDTO1"];
export type GroupSearchResultDTO =
  components["schemas"]["GroupSearchResultDTO"];
export type HighlightedFieldDTO = components["schemas"]["HighlightedFieldDTO"];
export type LearningResourceType =
  components["schemas"]["LearningResourceType"];
...
export type MultiSearchResultDTO =
  components["schemas"]["MultiSearchResultDTO"];
export type MultiSearchSuggestionDTO =
  components["schemas"]["MultiSearchSuggestionDTO"];
export type MultiSearchSummaryDTO =
  components["schemas"]["MultiSearchSummaryDTO"];
export type MultiSearchSummaryDTO1 =
  components["schemas"]["MultiSearchSummaryDTO1"];
export type MultiSearchTermsAggregationDTO =
  components["schemas"]["MultiSearchTermsAggregationDTO"];
