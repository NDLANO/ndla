...
export const fetchLearningpathsWithArticle = (
  id: number,
): Promise<LearningPathSummaryV2DTO[]> =>
  client
...
export const learningpathSearch = async (
  ...
  return client
    .POST("/learningpath-api/v2/learningpaths/search", { body: query })
    .then(resolveJsonOATS);
};
...
export const postLearningpath = async (
  learningpath: NewLearningPathV2DTO,
): Promise<LearningPathV2DTO> => {
...
export const deleteLearningpathLanguage = async (
  id: number,
  language: string,
): Promise<boolean> => {
...
export const postLearningStep = async (
  id: number,
...
export const putLearningStepOrder = async (
  learningpathId: number,
  stepId: number,
  seqNo: number,
): Promise<boolean> => {
...
export const fetchLearningStepSamples = async (): Promise<
  LearningPathV2DTO[]
> => {
