...
const validNodeTypes = [PROGRAMME, SUBJECT_NODE, TOPIC_NODE, NODE] as const;

export type ResolvedNodeType = (typeof validNodeTypes)[number];

export const getNodeTypeFromNodeId = (id: string): ResolvedNodeType => {
