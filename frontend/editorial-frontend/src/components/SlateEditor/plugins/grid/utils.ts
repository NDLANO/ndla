...
export const defaultGridCellBlock = () => {
  return slatejsx("element", { type: GRID_CELL_ELEMENT_TYPE, data: {} }, defaultParagraphBlock());
};

export const defaultGridBlock = () => {
  return slatejsx("element", { type: GRID_ELEMENT_TYPE, data: { columns: 2, border: "none" } }, [
