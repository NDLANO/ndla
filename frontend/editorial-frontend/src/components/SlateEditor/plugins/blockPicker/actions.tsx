...
export const commonActions: Action[] = [
  { data: { type: ASIDE_ELEMENT_TYPE, object: "factAside" }, icon: <FileListFill />, bookmark: "#bkmrk-faktaboks" },
  {
    data: { type: DETAILS_ELEMENT_TYPE, object: "details" },
    icon: <ExpandDiagonalLine />,
    bookmark: "#bkmrk-ekspanderende-boks",
  },
  { data: { type: TABLE_ELEMENT_TYPE, object: "table" }, icon: <TableLine />, bookmark: "#bkmrk-tabell" },
  {
    data: { type: FRAMED_CONTENT_ELEMENT_TYPE, object: "framedContent" },
    icon: <SquareLine />,
    bookmark: "#bkmrk-tekst-i-ramme",
  },
  { data: { type: IMAGE_ELEMENT_TYPE, object: "image" }, icon: <CameraFill />, bookmark: "#bkmrk-bilde" },
  { data: { type: BRIGHTCOVE_ELEMENT_TYPE, object: "video" }, icon: <MovieLine />, bookmark: "#bkmrk-video" },
  { data: { type: AUDIO_ELEMENT_TYPE, object: "audio" }, icon: <VolumeUpFill />, bookmark: "#bkmrk-lyd" },
  { data: { type: AUDIO_ELEMENT_TYPE, object: "podcast" }, icon: <BroadcastLine />, bookmark: "#bkmrk-podkastepisode" },
  { data: { type: H5P_ELEMENT_TYPE, object: "h5p" }, icon: <SlideshowLine />, bookmark: "#bkmrk-h5p" },
  { data: { type: EXTERNAL_ELEMENT_TYPE, object: "url" }, icon: <LinkMedium />, bookmark: "#bkmrk-ressurs-fra-lenke" },
  { data: { type: FILE_ELEMENT_TYPE, object: "file" }, icon: <DownloadLine />, bookmark: "#bkmrk-fil" },
  { data: { type: CODE_BLOCK_ELEMENT_TYPE, object: "code" }, icon: <CodeView />, bookmark: "#bkmrk-kodevisning" },
  { data: { type: DISCLAIMER_ELEMENT_TYPE, object: "disclaimer" }, icon: <AlertLine />, bookmark: "#bkmrk-kommentar" },
  {
...
export const frontpageActions = commonActions.concat(
  { data: { type: GRID_ELEMENT_TYPE, object: "grid" }, icon: <LayoutColumnLine />, bookmark: "#bkmrk-grid" },
  { data: { type: PITCH_ELEMENT_TYPE, object: "pitch" }, icon: <StickyNoteAddLine /> },
  { data: { type: KEY_FIGURE_ELEMENT_TYPE, object: "keyFigure" }, icon: <LineChartLine /> },
  { data: { type: CONTACT_BLOCK_ELEMENT_TYPE, object: "contactBlock" }, icon: <UserFill /> },
  { data: { type: CAMPAIGN_BLOCK_ELEMENT_TYPE, object: "campaignBlock" }, icon: <MegaphoneLine /> },
  { data: { type: LINK_BLOCK_LIST_ELEMENT_TYPE, object: "linkBlockList" }, icon: <LinkMedium /> },
);
...
export const learningResourceActions = commonActions.concat(
  ...
  { data: { type: GLOSS_BLOCK_ELEMENT_TYPE, object: "gloss" }, icon: <GlobalLine />, bookmark: "#bkmrk-glose" },
  { data: { type: GRID_ELEMENT_TYPE, object: "grid" }, icon: <LayoutColumnLine />, bookmark: "#bkmrk-grid" },
);
