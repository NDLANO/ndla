...
export const toFormArticle = (article: ArticleDTO | ArticleV2DTO, language: string): FormArticle => {
  return {
    id: article.id,
...
export const PreviewDraft = (props: Props) => {
  ...
  const { article } = useTransformedArticle({ draft, language, previewAlt, useDraftConcepts: false });
