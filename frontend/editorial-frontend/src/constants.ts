...
export const LEARNING_PATH_ADMIN_SCOPE = "learningpath:admin";
...
export const TAXONOMY_CUSTOM_FIELD_FROZEN_SUBJECT = "frozen";
...
export const STORED_PAGE_SIZE_REVISION_VIEW_LMA = "STORED_PAGE_SIZE_REVISION_VIEW_LMA";
export const STORED_PAGE_SIZE_REVISION_VIEW_DA = "STORED_PAGE_SIZE_REVISION_VIEW_DA";
export const STORED_PAGE_SIZE_REVISION_VIEW_SA = "STORED_PAGE_SIZE_REVISION_VIEW_SA";
export const STORED_PAGE_SIZE_REVISION_VIEW_FAVORITES = "STORED_PAGE_SIZE_REVISION_VIEW_FAVORITES";

export const STORED_PAGE_SIZE_PUBLISHED_VIEW_LMA = "STORED_PAGE_SIZE_PUBLISHED_VIEW_LMA";
export const STORED_PAGE_SIZE_PUBLISHED_VIEW_DA = "STORED_PAGE_SIZE_PUBLISHED_VIEW_DA";
export const STORED_PAGE_SIZE_PUBLISHED_VIEW_SA = "STORED_PAGE_SIZE_PUBLISHED_VIEW_SA";
export const STORED_PAGE_SIZE_PUBLISHED_VIEW_FAVORITES = "STORED_PAGE_SIZE_PUBLISHED_VIEW_FAVORITES";
export const STORED_SHOW_REPUBLISHED = "STORED_SHOW_REPUBLISHED";
...
export const STORED_FILTER_PUBLISHED = "STORED_FILTER_PUBLISHED";
