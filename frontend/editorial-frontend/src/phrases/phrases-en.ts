...
const phrases = {
  ...
  symbols: {
    ...
    degrees: "Degrees",
    yen: "Yen",
    nonBreakingHyphen: "Hard hyphen",
    enDash: "En dash",
    nonBreakingSpace: "Non breaking space",
    paragraph: "Paragraph",
    invertedQuestionMark: "Inverted questionmark",
    alpha: "Alpha",
    beta: "Beta",
    gamma: "Gamma",
  ...
  searchForm: {
    ...
    tagType: {
      ...
      users: "Editor: {{value}}",
      "query-fields": "Query fields: {{value}}",
    ...
    noResponsibles: "Without responsible",
  ...
  taxonomy: {
    ...
    supplementary: {
      ...
      addNew: "New supplementary content",
      dialogTitle: "Add supplementary content",
    },
    learningpath: {
      title: "Learning paths about the topic",
      addNew: "New learning path",
      dialogTitle: "Add learning path",
    },
    link: {
      title: "Multidisciplinary cases",
      addNew: "New multidisciplinary case",
