...
export const NDLAFILM_RESOURCE_TYPE_DOCUMENTARY =
  "urn:resourcetype:documentary";
export const NDLAFILM_RESOURCE_TYPE_FEATURE_FILM =
...
export const UKR_PAGE_URL =
  "/f/ukrainian-resources-in-norwegian-social-science/1022072a8411";
