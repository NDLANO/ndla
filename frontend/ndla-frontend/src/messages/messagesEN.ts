...
const messages = {
  ...
  htmlTitles: {
    ...
    myFavoritesPage: `My favorites - ${titleTemplate}`,
    myFolderPage: `{{folderName}} - ${titleTemplate}`,
    sharedFolderPage: `{{name}} - ${titleTemplate}`,
    mySubjectsPage: `My subjects - ${titleTemplate}`,
    myProfilePage: `My profile - ${titleTemplate}`,
  ...
  myNdla: {
    ...
    resource: {
      ...
      removedFromFailed: 'Could not remove resource from folder "{{name}}"',
      ...
      selectResource: "Select {{resourceName}}",
    ...
    quiz: {
      ...
      form: {
        ...
        settings: {
          title: "Settings",
          description: "Choose settings for the question type.",
          multipleAnswers: "Multiple correct answers",
        ...
        alternativeNumber: "Answer alternative {{number}}",
        alternativePlaceholder: "Write answer alternative here",
        addAlternative: "Add answer alternative",
      ...
      take: {
        ...
        result: {
          heading: "Well done!",
          headingLow: "You can do better!",
          score: "You have {{correct}} out of {{total}} correct answers.",
          scorePillTotal: " / {{total}} correct",
          retry: "Try again",
    ...
    folder: {
      ...
      folders: "Folders",
      resources: "Resources",
      noResources: "You have not added any resources here yet.",
  ...
  footer: {
    info: "NDLA is a collaboration between all of Norway's counties.",
