...
const translations = {
  htmlTitles: {
    ...
    myFavoritesPage: `Mine favoritter - ${titleTemplate}`,
    myFolderPage: `{{folderName}} - ${titleTemplate}`,
    sharedFolderPage: `{{name}} - ${titleTemplate}`,
    mySubjectsPage: `Mine fag - ${titleTemplate}`,
    myProfilePage: `Min profil - ${titleTemplate}`,
  ...
  myNdla: {
    ...
    resource: {
      ...
      updateTags: "Endre emneknagger",
      show: "Vis",
      save: "Lagre ressurs",
      move: "Flytt",
      moved: "Flytta",
      moveResourceFailed: "Klarte ikke å flytte ressursen",
      movedResource: "Flyttet ressursen",
      moveResourceTitle: "Flytt ressurs",
      batchSelect: "Velg flere",
      selectResource: "Velg {{resourceName}}",
        ...
        content: {
          ...
          text: {
            ...
            introduction: {
              label: "Ingress",
              labelHelper:
                "Skriv en kort ingress hvor du oppsummerer innholdet i steget ditt.",
            },
            description: {
              label: "Innhold",
    ...
    quiz: {
      ...
      form: {
        ...
        settings: {
          title: "Innstillinger",
          description: "Velg innstillinger for spørsmålstypen.",
          multipleAnswers: "Flere rette svar",
        ...
        alternative: "Svaralternativ",
        alternativeNumber: "Svaralternativ {{number}}",
        alternativePlaceholder: "Skriv svaralternativ her",
        addAlternative: "Legg til svaralternativ",
      ...
      unshareConfirm: {
        ...
        content:
          "Ved å avslutte deling slutter lenken du har delt å virke. Du kan velge å dele igjen på et senere tidspunkt.",
      },
      toast: {
        ...
        unshared: 'Kvisen "{{ title }}" er ikke lenger delt.',
        unshareFailed: "Kunne ikke avslutte deling av kvisen.",
      },
      saveQuiz: {
        pageHeading: "Lagre og del",
        pageDescription:
          "Lagre og del kvissen din. Når du deler oppretter du en delbar lenke som du kan sende til elever eller lærere.",
        saveAndClose: "Lagre og lukk",
      },
      take: {
        start: "Start kviss",
        ...
        estimatedMinutes_other: "{{count}} minutter",
        copyQuiz: "Kopier kviss",
        saveQuizLink: "Lagre lenke til kviss",
        saveQuizLinkComingSoon: "Kommer snart",
        sharedBy: "Delt av: NDLA-bruker",
        beforeStart: {
          title: "Før du begynner:",
          selectAnswer: "Du må velge minst ett svaralternativ per spørsmål.",
          retry: "Hvis du svarer feil kan du prøve kvissen på nytt senere!",
        },
        ...
        checkQuizFailed: "Noe gikk galt under kontroll av svarene dine. Prøv igjen.",
        next: "Neste spørsmål",
    ...
    folder: {
      ...
      save: "Lagre mappe",
      added: "Lagt til",
      moveFolderFailed: "Klarte ikke å flytte mappen",
  ...
  validation: {
    ...
    maxLengthField:
      "$t(validation.fields.{{field}}) kan innholde maks {{count}} tegn",
    properUrl:
  ...
  welcomePage: {
    ...
    quickLinks: {
      ...
      chatRobot: {
        ...
        description:
          "Bygg din egen robot eller bruk en ferdiglaget! Våre KI-verktøy er trygge og klare til bruk.",
      },
      arena: {
        title: "NDLA Arena",
        description:
  ...
  revision: {
    ...
    currentRevision: "Nyeste versjon av læringsressursen.",
    inRevisionWarning:
      "Det kan finnes flere versjoner av denne læringsressursen. Versjonen du ser på, kan inneholde utdatert informasjon eller ha andre feil.",
    outdatedRevision:
      "Det finnes en nyere versjon av denne læringsressursen. Det kan hende innhold ikke virker eller at informasjonen er utdatert.",
  },
  revisionsPage: {
