...
const translations = {
  htmlTitles: {
    ...
    myFavoritesPage: `Mine favorittar - ${titleTemplate}`,
  ...
  subjectsPage: {
    ...
    viewMoreVideos: "Sjå fleire læringsressursar med filmar",
  },
  topicsPage: {
    topics: "Emne",
  },
  ...
  myNdla: {
    ...
    sharedFolder: {
      ...
      description:
        "I denne delte mappa finn du fagstoff og oppgåver frå NDLA. Artiklane er samla og delt av ein lærar.",
    ...
    quiz: {
      ...
      sharing: {
        ...
        editBanner:
          "Denne kvissen er delt. Alle endringar du gjer blir synlege for dei som har lenka.",
      ...
      form: {
        ...
        cardTitle: "Kviss",
        renameQuiz: "Endre namn",
        navigation: "Kvissnavigasjon",
        questionType: {
          label: "Type spørsmål",
          singleChoice: "Eitt svar",
          multipleChoice: "Fleirval",
        },
        tabs: {
          questions: "Spørsmål",
        },
        ...
        settings: {
          title: "Innstillingar",
          description: "Vel innstillingar for spørsmålstypen.",
          multipleAnswers: "Fleire rette svar",
          randomOrder: "Tilfeldig rekkefølgje på svaralternativ?",
      ...
      leaveConfirm: {
        ...
        content:
          "Dersom du går ut av Kvissen utan å lagre vil du miste alt innhaldet ditt. ",
      ...
      take: {
        ...
        estimatedMinutes_other: "{{count}} minutt",
        copyQuiz: "Kopier kviss",
        saveQuizLink: "Lagre lenke til kviss",
        saveQuizLinkComingSoon: "Kjem snart",
        sharedBy: "Delt av: NDLA-brukar",
        beforeStart: {
          title: "Før du byrjar:",
          selectAnswer: "Du må velje minst eitt svaralternativ per spørsmål.",
          retry: "Viss du svarer feil kan du prøve kvissen på nytt seinare!",
        },
        singleChoiceHint: "Vel eitt rett svar.",
        multipleChoiceHint: "Fleire rette svar.",
        ...
        result: {
          ...
          retry: "Prøv igjen",
          summaryTitle: "Oppsummering av kvisset",
          correctAnswer: "Rett svar: {{answer}}",
          yourAnswerCorrect: "Ditt svar - rett",
          yourAnswerIncorrect: "Ditt svar - feil",
          correctNotSelected: "Rett svar - ikkje valt",
          notSelectedIncorrect: "Feil svar - ikkje valt",
          partialFeedback:
            "Du valde {{correct}} rette og {{incorrect}} feil svar. {{missing}} rett svar manglar.",
        },
      },
    },
    description:
    ...
    folder: {
      ...
      sharing: {
        ...
        button: {
          ...
          saveLink: "Lagre lenka til mappa",
