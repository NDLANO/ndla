...
export const FeideSection = ({
  ...
  const authorized = authProps.authSelectors
    .authorized()
    .get(FEIDE_SCHEME_NAME);
    ...
    <div className="auth-container">
      ...
      <div className="auth-btn-wrapper">
        {authorized ? (
          ...
          <Button
            className="btn modal-btn auth authorize"
            onClick={loginWithFeide}
            aria-label="Log in with Feide"
          >
            Authorize
          </Button>
        )}
        <Button
          ...
          onClick={() => authProps.authActions.showDefinitions(false)}
        >
          Close
        </Button>
      </div>
